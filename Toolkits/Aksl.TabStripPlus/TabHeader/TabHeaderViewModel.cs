...
namespace Aksl.TabStripPlus.ViewModels
{
    public class TabHeaderViewModel : BindableBase
    {
        ...
        {
            TabHeaderItemViewModel newTabHeaderItemViewModel = new(tabPlusInformation);
        ...
        public void SetTabHeaderItem(TabPlusInformation tabPlusInformation)
        {
            var activeTabHeaderItem = GetActiveTabHeaderItemByInfo(tabPlusInformation);
            ...
            {
                var storeTabHeaderItem = GetStoreTabHeaderItemViewModelByInfo(tabPlusInformation);
        ...
        private TabHeaderItemViewModel GetActiveTabHeaderItemByInfo(TabPlusInformation tabPlusInformation)
        {
            var activeTabHeaderItem = ActiveTabHeaderItems.FirstOrDefault(th => IsEqualsNameOrTitle(th.Name, tabPlusInformation.Name) || IsEqualsNameOrTitle(th.Title, tabPlusInformation.Title));

            return activeTabHeaderItem;
        }

        public TabHeaderItemViewModel GetStoreTabHeaderItemViewModelByInfo(TabPlusInformation tabPlusInformation)
        {
            var storeTabHeaderItem = StoreTabHeaderItems.FirstOrDefault(sth => IsEqualsNameOrTitle(sth.Name, tabPlusInformation.Name) || IsEqualsNameOrTitle(sth.Title, tabPlusInformation.Title));

            return storeTabHeaderItem;
        }

        private TabHeaderItemViewModel GetNextActiveTabHeaderItemByInfo(TabPlusInformation tabPlusInformation)
        {
            TabHeaderItemViewModel nextTabHeaderItemViewModel = default;

            var index = ActiveTabHeaderItems.ToList().FindIndex(th => IsEqualsNameOrTitle(th.Name, tabPlusInformation.Name) || IsEqualsNameOrTitle(th.Title, tabPlusInformation.Title));
        ...
        {
            var isAny = ActiveTabHeaderItems.Any(th => th.IsSelected && (IsEqualsNameOrTitle(th.Name, tabPlusInformation.Name) || IsEqualsNameOrTitle(th.Title, tabPlusInformation.Title)));
